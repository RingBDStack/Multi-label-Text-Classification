...
class LSTMModel(object):
    def __init__(self, n_voc, trainset, testset, dataname, classes, prefix):
        ...
        self.test_model = theano.function(
            inputs=[docs,wordmask,sentencemask,maxsentencenum],
            outputs=predict,
        )
    ...
    def test(self):
        ...
        for i in xrange(self.testset.epoch):
            predicted_value = self.test_model(self.testset.docs[i],self.testset.wordmask[i],self.testset.sentencemask[i],self.testset.maxsentencenum[i])
